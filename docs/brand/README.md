...
This repository keeps brand guidance as URL pointers only. Canonical brand prose lives in Linear and should not be duplicated in git.

## Canonical Linear docs

- Brand: Index — <https://linear.app/edvinasg/document/brand-index-ee8962537295> (`brand-index-ee8962537295`)
- PRD: Qaily-Brand — <https://linear.app/edvinasg/document/prd-qaily-brand-f78966648a52> (`prd-qaily-brand-f78966648a52`)
- Brand: Channel copy (drafts) — use the current link from **Brand: Index**
